 ...
 * @private {number} id Unique identifier (Population Index)
 * @private {p5Vector} position Current position vector
 * @private {p5Vector} velocity Current velocity vector (Origin = position)
 * @private {p5Vector} courseCorrection Current correction vector (alignment, cohesion, separation) (Origin = position)
 * @private {p5Color} colorBody Main color of this boid
 * @private {p5Color} colorStroke Stroke color of this boid
