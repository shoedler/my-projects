...
#define STRING_CONFIG_H_AUTHOR "(Simon, Ender-3-Pro)" // Who made the changes.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 96 + X_PROBE_OFFSET_FROM_EXTRUDER 
  //#define RIGHT_PROBE_BED_POSITION 219 
  #define FRONT_PROBE_BED_POSITION 62 + Y_PROBE_OFFSET_FROM_EXTRUDER
  //#define BACK_PROBE_BED_POSITION 219
